...
class EvalCallback():
    ...
    def on_epoch_end(self, epoch, model_eval):
        if epoch % self.period == 0 and self.eval_flag:
            self.net = model_eval
            gt_dir = os.path.join(self.dataset_path, "C:\\Users\\admini\\PycharmProjects\\pythonProject10\\hua\\class\\")
            ...
            for image_id in tqdm(self.image_ids):
                ...
                #   从文件中读取图像
                # -------------------------------#
                image_path = os.path.join(self.dataset_path, "C:\\Users\\admini\\PycharmProjects\\pythonProject10\\hua\\images\\" + image_id + ".jpg")
